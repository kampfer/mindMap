...
kampfer.mindMap.command.pushCommandToStack = function(command) {
	var length = this.commandList.length - this.index;
	this.commandList.splice(this.index++, length, command);
};


kmapfer.mindMap.command.Base = kampfer.mindMap.Class.extend({
	init : function() {},
